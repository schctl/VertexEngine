...
namespace Vertex
{
    ...
    Application::Application() : m_Running(true), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f)
    {
        ...
        m_Shader.reset(Shader::Create<1, 2>(vertex_src, fragment_src,
            VulkanBufferBindings<1, VulkanBufferBinding<glm::vec3, 0, 0, 0, VK_FORMAT_R32G32B32_SFLOAT>,
                VulkanBufferBinding<glm::vec4, 0, 1, sizeof(glm::vec3), VK_FORMAT_R32G32B32A32_SFLOAT,
